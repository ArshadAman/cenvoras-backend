...
from .views import (
    ...
    purchase_order_list_create, purchase_order_detail, purchase_order_convert_to_bill,
)
...
urlpatterns = [
    ...
    path('sales-invoices/evaluate-schemes/', views.evaluate_invoice_schemes, name='evaluate_invoice_schemes'),
    ...
    path('sales-invoices/<uuid:pk>/pdf/', views.sales_invoice_pdf_download, name='sales_invoice_pdf_download'),
    ...
    path('quotations/<uuid:pk>/pdf/', views_sidecar.quotation_pdf_download, name='quotation_pdf_download'),
