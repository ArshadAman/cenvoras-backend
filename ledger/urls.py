...
urlpatterns = [
    ...
    path('create-journal-entry/', create_manual_journal_entry, name='create_manual_journal_entry'),
    path('repair-round-off/', repair_round_off_entries, name='repair_round_off_entries'),
