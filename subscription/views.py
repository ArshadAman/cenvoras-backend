...
def plan_catalog(request):
	...
	for plan in plans:
		data.append({
			...
			'quarterly_price': str(plan.quarterly_price),
			'yearly_price': str(plan.yearly_price),
			'original_monthly_price': str(plan.original_monthly_price),
			'original_quarterly_price': str(plan.original_quarterly_price),
			'original_yearly_price': str(plan.original_yearly_price),
